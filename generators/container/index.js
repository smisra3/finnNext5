...
module.exports = {
  description: 'Add a container component (organisms, templates)',
  prompts: [
    {
      type: 'list',
      name: 'type',
  ...
  actions: (data) => {
    ...
    const actions = [
      ...
      {
        type: 'add',
        path: '../app/components/{{ folder }}/{{properCase name}}/tests/index.test.js',
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path: '../app/components/{{ folder }}/{{properCase name}}/{{properCase name}}.actions.js',
        templateFile: './container/actions.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: '../app/components/{{ folder }}/{{properCase name}}/tests/actions.test.js',
      ...
      actions.push({
        type: 'add',
        path: '../app/components/{{ folder }}/{{properCase name}}/{{properCase name}}.constants.js',
      ...
      actions.push({
        type: 'add',
        path: '../app/components/{{ folder }}/{{properCase name}}/{{properCase name}}.reducer.js',
        templateFile: './container/reducer.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: '../app/components/{{ folder }}/{{properCase name}}/tests/reducer.test.js',
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path: '../app/components/{{ folder }}/{{properCase name}}/{{properCase name}}.saga.js',
        templateFile: './container/saga.js.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: '../app/components/{{ folder }}/{{properCase name}}/tests/saga.test.js',
